...
export const Contact = () => {
    ...
    return (
        <section className="contact" id="writeToMe">
            <Container>
                                ...
                                <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                                    ...
                                    <form onSubmit={handleSubmit}>
                                        <Row>
                                            ...
                                            <Col size={12} sm={6} className="px-1">
                                                <input type="text" required={true} value={formDetails.lastName} placeholder="Last Name" onChange={(e) => onFormUpdate('lastName', e.target.value)}/>
                                            </Col>
                                            <Col size={12} sm={6} className="px-1">
                                            ...
                                            <Col size={12} sm={6} className="px-1">
                                                <input type="tel" required={true} value={formDetails.phone} placeholder="Phone No." onChange={(e) => onFormUpdate('phone', e.target.value)}/>
                                            </Col>
